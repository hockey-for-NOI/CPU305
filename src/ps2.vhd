...
ARCHITECTURE behavior OF ps2 IS
...
signal last : std_logic_vector(7 downto 0):= x"FF";
...
BEGIN
  ...
  ps2_keyboard_0:  ps2_keyboard
	...
	if (rst = '0') then
		...
		can_read_v <= '0';
		ascii_code <= "00000000";
		read_ascii_code <= "11111111";
	elsif (read_en = '1' and can_read_v = '1') then
		read_ascii_code <= last;
		can_read_v<='0';
